...
var baseUrl="https://livedemo.espressologic.com/rest/demo/Demo_KpsTb/v1/";

// The API key use to access the demo project
var currentApiKey = "8QTiqF4M0s0dQCX";
...
function highlightChanges() {
	for (var j = 0; j < allChanges.length; j++) {
		...
		console.log('qtip for: ' + allChanges[j]);
		$("#" + allChanges[j]).qtip("show");
		console.log('after qtip for: ' + allChanges[j]);
	}
	allChanges = [];
}
